<%@ Page Language="VB" AutoEventWireup="false" CodeFile="aDelete.aspx.vb" Inherits="Admin_aDelete" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="lblMsg" runat="server" Style="left: 237px; color: red; position: absolute;
            top: 578px"></asp:Label>
