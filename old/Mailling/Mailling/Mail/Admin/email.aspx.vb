...
Partial Class Admin_email
    ...
    Protected Sub cmdSend_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdSend.Click
        ...
        If chk = "" Then
            ...
            msg.From = New MailAddress("blossom.poe@gmail.com", "Pidilite", System.Text.Encoding.UTF8)
            ...
            client.Credentials = New System.Net.NetworkCredential("blossom.poe@gmail.com", "blos487")
            client.Port = 587
            ...
            Catch ex As Exception
                lblMsg.Text = "Error in sending email.Please chack the email address"
            End Try
        Else
            lblMsg.Text = chk
        End If
