<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Scheme.aspx.vb" Inherits="Admin_Scheme" %>
...
<body>
    ...
    <div>
        ...
        &nbsp;
        &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
        <asp:Button ID="Button2" runat="server" Height="30px" Text="Add new " Width="88px" />
        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        <asp:Button ID="Button3" runat="server" Height="33px" Text="Delete" Width="72px" /></div>
        </form>
</body>
</html>
