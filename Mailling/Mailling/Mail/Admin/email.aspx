<%@ Page Language="VB" AutoEventWireup="false" CodeFile="email.aspx.vb" Inherits="Admin_email" %>
...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="txtEmail" runat="server" Style="left: 322px; position: absolute;
            top: 264px" Width="320px" BorderColor="Navy" BorderStyle="Groove" BorderWidth="2px" TabIndex="1"></asp:TextBox>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Enter correct Email id" style="left: 666px; color: red; position: absolute;top: 265px" ControlToValidate="txtEmail" ValidationExpression="^[a-zA-Z][\w\.-]*[a-zA-Z0-9]@[a-zA-Z0-9][\w\.-]*[a-zA-Z0-9]\.[a-zA-Z][a-zA-Z\.]*[a-zA-Z]$" Width="146px"></asp:RegularExpressionValidator>
        ...
        <asp:TextBox ID="txtSubject" runat="server" Style="left: 327px; position: absolute;
            top: 331px" Width="315px" BorderColor="Navy" BorderStyle="Groove" BorderWidth="2px" TabIndex="2"></asp:TextBox>
        ...
        <asp:TextBox ID="txtMsg" runat="server" Height="202px" Style="left: 329px; position: absolute;
            top: 406px" Width="437px" BorderColor="Navy" BorderStyle="Groove" BorderWidth="2px" TabIndex="3"></asp:TextBox>
        <br />
        <br />
        <br />
        <br />
        ...
        <table style="left: 285px; width: 382px; position: absolute; top: 655px">
            <tr>
                <td style="width: 181px; height: 33px;">
                    <asp:Button ID="cmdSend" runat="server" Text="Send" Font-Bold="True" Font-Size="Large" ForeColor="Navy" TabIndex="4" />
                </td>
                <td style="height: 33px">
                    <asp:Button ID="cmdClear" runat="server" Text="Clear" Font-Bold="True" Font-Size="Large" ForeColor="Navy" TabIndex="5" /></td>
            </tr>
        </table>
