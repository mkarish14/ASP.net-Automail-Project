    ...
    <div>
        ...
        <asp:Menu ID="Menu1" runat="server" BackColor="Goldenrod" DynamicHorizontalOffset="2"
            ...
            <Items>
                ...
                <asp:MenuItem NavigateUrl="~/Common/Default.aspx" Text="Log Out" Value="Log in"></asp:MenuItem>
        ...
        <table style="left: 460px; width: 410px; position: absolute; top: 466px">
            <tr>
                <td style="width: 100px; height: 26px">
                    ...
                    <asp:Label ID="lblMsg" runat="server" Style="left: -15px; color: red; position: absolute;
                        top: -233px" Font-Bold="True" Font-Size="Large" ForeColor="#C00000"></asp:Label>
                </td>
            </tr>
        </table>
